    ...
    <section className="p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <p>
            I am a software developer educated in classical music, currently specializing in tech entrepreneurship and business development. With experience in product management, team leadership, and digitization strategies, I bring a unique interdisciplinary perspective. My background in classical music informs a creative approach to building and managing technology, complemented by my multi-language skills.
          </p>
